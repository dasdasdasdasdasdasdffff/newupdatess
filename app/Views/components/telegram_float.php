...
<a href="https://t.me/Capital_Nest_Nepal" target="_blank" rel="noopener noreferrer"
    ...
    <span class="grid h-7 w-7 place-items-center rounded-full bg-white/20">
        <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current" aria-hidden="true">
            <path d="M21.6 3.4 18.5 20c-.2 1.2-.9 1.5-1.8.9l-5-3.7-2.4 2.3c-.3.3-.5.5-1 .5l.4-5.1 9.3-8.4c.4-.4-.1-.6-.6-.2L6 13.7 1.1 12.2c-1.1-.3-1.1-1 .2-1.5L20.4 3c.9-.3 1.7.2 1.2.4Z"/>
        </svg>
    </span>
    <span class="text-[10px] font-bold tracking-wide sm:text-[11px]">Join for updates</span>
</a>
